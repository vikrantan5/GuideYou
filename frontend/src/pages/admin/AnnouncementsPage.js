  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold" data-testid="announcements-page-title">Announcements</h2>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button data-testid="create-announcement-dialog-trigger">
              <Megaphone className="w-4 h-4 mr-2" />
              New Announcement
            </Button>
          </DialogTrigger>
          <DialogContent className="max-w-2xl" data-testid="create-announcement-dialog">
            <DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <DialogFooter>
                ...
                <Button type="submit" data-testid="submit-create-announcement-button">Publish</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
        ...
        {announcements.length === 0 ? (
          <Card>
            <CardContent className="py-12">
              <p className="text-center text-muted-foreground">No announcements yet. Create your first one!</p>
            </CardContent>
          </Card>
        ) : (
