  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold flex items-center gap-2" data-testid="ai-helper-page-title">
          <Brain className="w-8 h-8 text-purple-600" />
          AI Doubt Solver
        </h2>
        {chatHistory.length > 0 && (
          <Button variant="outline" onClick={handleClearChat} data-testid="clear-chat-button">
            Clear Chat
          </Button>
        )}
      </div>
          ...
          <div className="space-y-4 min-h-[400px] max-h-[600px] overflow-y-auto">
            {chatHistory.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-[400px] text-center">
                ...
                <p className="text-muted-foreground">No messages yet. Ask your first question!</p>
              </div>
            ) : (
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleAskQuestion} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button type="submit" disabled={loading || !question.trim()} data-testid="ask-ai-button">
                {loading ? (
                  <>
